...
For finding the degree sequence the complexity is O(V^2). Finding the number of edges is also O(V^2). Then comparing the two graphs is V so the wort case is O(V^5).
